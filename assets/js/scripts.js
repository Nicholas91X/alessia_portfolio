...
function image_setup() {
	...
	function img_three(opts) {
		...
		function core() {
			...
			function set_aspect() {
				var parentRatio = parent.offsetHeight / parent.offsetWidth;
				var imageRatio = 2600 / 2079; // Rapporto altezza/larghezza originale dell'immagine

				if (parentRatio < imageRatio) {
					a1 = parent.offsetWidth / parent.offsetHeight * imageRatio;
					a2 = 1;
				} else {
					a1 = 1;
					a2 = parent.offsetHeight / parent.offsetWidth / imageRatio;
				}
			} set_aspect();
